...
**TODO** Entry types (family, domain, repeat, site or homologous superfamily)
...
You can get the InterPro annotation for a protein by looking up its UniProt Accession ({numref}`interpro-browse`), or by running a new sequence search (TODO).
